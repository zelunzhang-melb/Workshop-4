...
public class XAxisSpin : MonoBehaviour
{
    ...
    // or public dsfsdfsf dssgdgd; or fdssdggds dsgsdg = 5;
    // public gameobject fsdfs;
    // public Camera dfsdf; (game other component)
    ...
    private void Update()
    {
        // GetComponent<dfs> ggdg

        // Time.deltaTime <- this is important for frame rate display
        // Time.deltaTime
